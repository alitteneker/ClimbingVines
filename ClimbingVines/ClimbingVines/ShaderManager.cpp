...
void set_ambient(float set) {
    ambient = set;
    glUniform4fv(uAmbient,  1, ambient  * colour);
}
void set_diffuse(float set) {
    diffuse = set;
    glUniform4fv(uDiffuse,  1, diffuse  * colour);
}
void set_specular(float set) {
    specular = set;
    glUniform4fv(uSpecular, 1, specular * colour);
}
void set_material(float set_ambient, float set_diffuse, float set_specular) {
    ambient = set_ambient; diffuse = set_diffuse; specular = set_specular;
    writeColour();
}
void set_material(float set_ambient, float set_diffuse, float set_specular, float set_shininess) {
    ambient = set_ambient; diffuse = set_diffuse; specular = set_specular; shininess = set_shininess;
    writeMaterial();
}
